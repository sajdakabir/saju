...
march started with one question.

am I taking action on my task, or just organising it on Notion to look good for Twitter?

every morning we open Gmail, calendar, Linear, GitHub, Slack. five tabs before coffee, just to know what the day looks like. we save founders' blog posts to read later, bookmark Naval's tweets to decode later, drop links into Notion to revisit later. later never comes. the tools we trust to remember things are the same tools that bury them.
...
- inbox — every connected object lands here. you stop opening 10 tools in the morning.
...
everything was new. couldn't find my answer on Stack Overflow. there was no Claude, no Cursor that you prompt and it builds the thing for you. you wrote it yourself or you didn't ship.
...
people often say: listen to users. but the moment you start listening to every user, you lose the vision. you start stacking features on top of features. the product becomes whatever the loudest user asked for last week.

while building march I learned to walk the fine line. listen to the user, but ask why. why this feature, why now, how does it fit the product you set out to build. the balance between user feedback and your own vision is the actual job.

don't bury this in Notion. :)
