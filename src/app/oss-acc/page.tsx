...
const securityFindings: SecurityFinding[] = [
  ...
  { id: 'PR-8274', date: 'Jul 30, 2026', project: 'bruno', title: 'Remote code execution via malicious collection documentation (Markdown XSS → IPC → shell)', severity: 'Critical', cvss: '', href: 'https://github.com/usebruno/bruno/pull/8274', published: true },
  ...
  { id: 'GHSA-cpx8-cffg-mp4w', date: 'Jul 21, 2026', project: 'trigger.dev', title: 'Overly broad realtime session credentials allow cross-session stream modification and deletion', severity: 'High', cvss: '8.1', href: 'https://github.com/triggerdotdev/trigger.dev/security/advisories/GHSA-cpx8-cffg-mp4w', published: true },
